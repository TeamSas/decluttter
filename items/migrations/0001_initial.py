    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('claimer_id', models.ForeignKey(related_name='claimed_items', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('poster_id', models.ForeignKey(related_name='posted_items', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Item',
